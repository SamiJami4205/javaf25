(function () {
    ...
    $('form').on('submit', function(e) {
        ...
        if (!valiidateParenetsConsent()) {
            showErrorMessage(document.getElementById('parent-consent'));
        }
    ...
    function validateTypes(el) {
        ...
        if (typeof valdateType[type] === 'function') {
    ...
    function  validateParentsConsent() {
        ...
        var constentContainer = document.getElementById('consent-container');
        var valid = true;

        if (constentContainer.className.indexOf('hide') === -1){
    ...
    function validateBio() {
        ...
        if (!valid) {
            setErrorMessage(bio, 'Please make sure ypur bio does not exceed 140 characters');
        }
        return valid;
    }
